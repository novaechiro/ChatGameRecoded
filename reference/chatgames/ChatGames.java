...
public class ChatGames extends JavaPlugin implements Listener {
   ...
   public boolean textEqualsWord(String game, String chatText, String word) {
      return this.getConfig().getBoolean(game + ".case-sensitive") ? ChatColor.stripColor(chatText).equals(word) : ChatColor.stripColor(chatText).equalsIgnoreCase(this.selected);
   }
